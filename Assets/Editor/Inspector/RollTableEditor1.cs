...
{
//    public class RollTableEditor1 : Editor
//    {
//        RollTableView m_TreeView;
//        SearchField m_SearchField;
//        const string kSessionStateKeyPrefix = "TVS";
//
//        RollTable rollTableObject
//        {
//            get { return (RollTable) target; }
//        }
//
//        void OnEnable()
//        {
...
//            var jsonState = SessionState.GetString(kSessionStateKeyPrefix + rollTableObject.GetInstanceID(), "");
//            if (!string.IsNullOrEmpty(jsonState))
//                JsonUtility.FromJsonOverwrite(jsonState, treeViewState);
//            var treeModel = new TreeModel<RollEntry>(rollTableObject.RollEntries);
//            m_TreeView = new RollTableView(treeViewState, treeModel);
...
//            Undo.undoRedoPerformed -= OnUndoRedoPerformed;
//
//            SessionState.SetString(kSessionStateKeyPrefix + rollTableObject.GetInstanceID(),
...
//            if (m_TreeView != null)
//            {
//                m_TreeView.treeModel.SetData(rollTableObject.RollEntries);
//                m_TreeView.Reload();
//            }
//        }
//
...
//        {
//            Undo.RecordObject(rollTableObject,
...
//                {
//                    Undo.RecordObject(rollTableObject, "Add Item To Asset");
//
...
//                {
//                    Undo.RecordObject(rollTableObject, "Remove Item From Asset");
//                    var selection = m_TreeView.GetSelection();
...
//        }
//
//        class RollTableView : TreeViewWithTreeModel<RollEntry>
//        {
//            public RollTableView(TreeViewState state, TreeModel<RollEntry> model) : base(state, model)
//            {
//                showBorder = true;
