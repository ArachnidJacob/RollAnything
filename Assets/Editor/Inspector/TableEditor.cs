...
public class TableEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        EditorGUI.BeginChangeCheck();
        {
            EditorGUILayout.LabelField(
                "Drag and drop Entry objects onto the Roll Table to add them. Enforces unique objects.");
            ...
            showRollElements =
                EditorGUILayout.PropertyField(newEntryTable,
                    new GUIContent("Roll Table")); // EditorGUILayout.Foldout(showRollElements, "Roll Table");
            GUI.Box(GUILayoutUtility.GetLastRect(), "");
    ...
    /// <summary>
    /// Draws a Roll Object with a link to its object, the m_Weight and the percentage chance of appearing in this loot table
    /// </summary>    
