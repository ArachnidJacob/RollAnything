...
namespace RollAnything
{
    ...
    /// <summary>
    /// A generic TableRoll table class, contains a collection of TableRoll Objects and functions that return the weighted objects randomly
    /// </summary>
    [CreateAssetMenu(fileName = "new rollTable", menuName = "Diluvion/RollTables/TableRoll Table")]
    public class Table : Entry
    {
        ...
        [SerializeField] public Entry entryToAdd = null;
        [SerializeField] public List<Entry> tableEntries = new List<Entry>();

        [SerializeField] public List<TableEntry> rollTable = new List<TableEntry>();
        ...
        /// <summary>
        /// Default TableRoll function, returns an object with the correct type from the weighted list;
        /// </summary>
...
//            Debug.Log("returning entry: " + e, e);
        ...
        /// <summary>
        /// Main TableRoll Function, checks target list of RollObjects for m_Weight, and rolls through to find an object
        /// </summary>   
...
//            Debug.Log("returned " + returnList.Count +" / " + rollList.Count +  " when filtering for types: "+ typeof(T).ToString(),this);
        ...
        /// <returns></returns>
        List<TableEntry> TypeAndQueryFilteredList<T>(System.Func<Entry, bool> query, List<SerializableSystemType> types)
            where T : Entry
        {
